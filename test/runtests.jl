...
@testset "Testing ShingakuMatching.jl" begin
    ...
    @testset "read_faculties" begin
        ...
        @testset "_generate_faculties" begin
            generated_facs = ShingakuMatching._generate_faculties(4, ones(Int, 4), [1, 9, 4, 8])
            available_for_list = [[1], [1, 2, 3, 5, 6, 7], [1, 2, 3], [5, 6, 7]]
    ...
    @testset "utility_factory" begin
        ...
        s_utility = ShingakuMatching.utility_factory(beta, gamma, faculty_vertical_quality_list, student_relative_quality_list, faculty_relative_quality_list, error_dist)
        f_utility = ShingakuMatching.utility_factory(beta, gamma, student_vertical_quality_list, faculty_relative_quality_list, student_relative_quality_list, error_dist)
